...
public class EcoPlatformConnector implements IEPDConnector {
	...
	private static Map<String, EnvProductInfo> envProdMap  = new HashMap<String, EnvProductInfo>();;
	private static List<EpdMetaDataJsonObject> epdMetaDataList = new ArrayList<EpdMetaDataJsonObject>();
    ...
    private EpdMetaDataJsonObject getEpdDatabaseObjectFromLocalList(String name) {
    	...
    	for (EpdMetaDataJsonObject e : epdMetaDataList) {
